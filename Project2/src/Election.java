...
public abstract class Election {
  ...
  /**
   * Sets the number of votes cast in the election.
   *
  ...
  /**
   * Prepares data on the candidates and ballots from the election file.
   *
   ...
   */
  public abstract int getNumInvalidBallots();
}
