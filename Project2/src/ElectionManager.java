...
public class ElectionManager {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("*********** Voting System 1.1 Team #18 ***********");
  ...
  /**
   * Runs the election for one election file.
   *
   * @param electionFile file object for the election file
   */
